...
muHist = zeros(maxIter,1); % history of chemical potentials

% run once to determine optimal chemical potential
for iter=1:maxIter
...
% freeze chemical potential at optimal value and rerun primal optimization
for iter=1:maxIter
    ...
    % 
    convHist(iter) = norm(Heff - (H0 - mu*eye(n) + diag(VH)));
...
% plot primal convergence
figure(3);semilogy(convHist)